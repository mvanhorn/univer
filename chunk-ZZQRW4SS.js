...
var SheetsNote = (props) => {
  ...
  const initialWidthRef = (0, import_react.useRef)(null);
  const currentRender = renderManagerService.getRenderById(activePopup.unitId);
  const [note, setNote] = (0, import_react.useState)(null);
  const applyResizeOffset = (0, import_react.useCallback)((width) => {
...
var FILTER_BY_OPTIONS = [
  { label: "sheets-table-ui.filter.by-values", value: "items" /* Items */ },
  { label: "sheets-table-ui.filter.by-conditions", value: "condition" /* Condition */ }
];
