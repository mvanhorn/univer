...
var FIND_SCOPE_OPTIONS = [
  { label: "find-replace.dialog.find-scope.current-sheet", value: "subunit" /* SUBUNIT */ },
  { label: "find-replace.dialog.find-scope.workbook", value: "unit" /* UNIT */ }
];
var FIND_DIRECTION_OPTIONS = [
  { label: "find-replace.dialog.find-direction.row", value: "row" /* ROW */ },
  { label: "find-replace.dialog.find-direction.column", value: "column" /* COLUMN */ }
];
var FIND_BY_OPTIONS = [
  { label: "find-replace.dialog.find-by.value", value: "value" /* VALUE */ },
  { label: "find-replace.dialog.find-by.formula", value: "formula" /* FORMULA */ }
];
