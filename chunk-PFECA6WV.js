...
} from "./chunk-ELKIVHXI.js";
import {
  getPatternType
} from "./chunk-TKSXJR5U.js";
import {
  FormulaEditor,
  RangeSelector
...
} from "./chunk-HINQTSXY.js";
import {
  FormulaRefRangeService,
  UniverSheetsFormulaPlugin
} from "./chunk-JBTX5AZD.js";
import {
  AFTER_CELL_EDIT,
...
var SheetsCfRenderController = class extends Disposable {
  ...
  _collectDirtyRanges(items, unitId, subUnitId) {
    ...
    items.forEach((item) => {
      ...
      const rule = (_a = item.rule) != null ? _a : item.cfId ? this._conditionalFormattingRuleModel.getRule(unitId, subUnitId, item.cfId) : null;
      if ((_b = rule == null ? void 0 : rule.ranges) == null ? void 0 : _b.length) {
  ...
  _markDirtySkeleton(items) {
    ...
    const currentSkeleton = skeletonManagerService == null ? void 0 : skeletonManagerService.getCurrentSkeleton();
    const dirtyRanges = this._intersectDirtyRangesWithRenderedRange(
      this._collectDirtyRanges(items, unitId, subUnitId),
      currentSkeleton == null ? void 0 : currentSkeleton.rowColumnSegment
    );
    if (dirtyRanges.length) {
      currentSkeleton == null ? void 0 : currentSkeleton.resetRangeCache(dirtyRanges);
    }
    skeletonManagerService == null ? void 0 : skeletonManagerService.reCalculate();
    (_a = render == null ? void 0 : render.mainComponent) == null ? void 0 : _a.makeDirty();
  }
  _markActiveSheetRulesDirty() {
    ...
    const unitId = workbook.getUnitId();
    const subUnitId = worksheet.getSheetId();
    const rules = (_a = this._conditionalFormattingRuleModel.getSubunitRules(unitId, subUnitId)) != null ? _a : [];
    if (!rules.length) {
      return;
    }
...
var ColorScaleStyleEditor = (props) => {
  ...
  const commonOptionDefinitions = [createOptionItem("num" /* num */), createOptionItem("percent" /* percent */), createOptionItem("percentile" /* percentile */), createOptionItem("formula" /* formula */)];
  const minOptions = [createOptionItem("min" /* min */), ...commonOptionDefinitions].map((option) => ({ ...option, label: localeService.t(option.label) }));
  const medianOptions = [createOptionItem("none"), ...commonOptionDefinitions].map((option) => ({ ...option, label: localeService.t(option.label) }));
  const maxOptions = [createOptionItem("max" /* max */), ...commonOptionDefinitions].map((option) => ({ ...option, label: localeService.t(option.label) }));
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "univer-mt-3 univer-flex univer-h-8 univer-items-center univer-gap-2", children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
        Select,
        {
...
var InputText = (props) => {
  ...
  if (type === "formula" /* formula */) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "univer-w-full", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
      FormulaEditor,
      {
        ref: formulaEditorRef,
        className: clsx(`univer-box-border univer-h-8 univer-w-full univer-cursor-pointer univer-items-center univer-rounded-lg univer-bg-white univer-pt-2 univer-transition-colors hover:univer-border-primary-600 dark:!univer-bg-gray-700 dark:!univer-text-white [&>div:first-child]:univer-px-2.5 [&>div]:univer-h-5 [&>div]:univer-ring-transparent`, borderClassName),
...
var DataBarStyleEditor = (props) => {
  ...
  const commonOptionDefinitions = [
    createOptionItem2("num" /* num */),
    createOptionItem2("percent" /* percent */),
    createOptionItem2("percentile" /* percentile */),
    createOptionItem2("formula" /* formula */)
  ];
  const minOptions = [createOptionItem2("min" /* min */), ...commonOptionDefinitions].map((option) => ({ ...option, label: localeService.t(option.label) }));
  const maxOptions = [createOptionItem2("max" /* max */), ...commonOptionDefinitions].map((option) => ({ ...option, label: localeService.t(option.label) }));
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "univer-mt-3 univer-flex univer-items-center univer-gap-3", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "univer-flex univer-items-center univer-text-xs", children: [
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
            Checkbox,
            {
              checked: !isShowValue,
    ...
    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "univer-mt-3 univer-flex univer-items-center univer-gap-2", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "univer-flex univer-items-center univer-gap-3", children: [
...
var getOperatorOptions = (type) => {
  switch (type) {
    case "text" /* text */: {
      return [
        createOptionItem3("containsText" /* containsText */),
        createOptionItem3("notContainsText" /* notContainsText */),
        createOptionItem3("beginsWith" /* beginsWith */),
        createOptionItem3("endsWith" /* endsWith */),
        createOptionItem3("equal" /* equal */),
        createOptionItem3("notEqual" /* notEqual */),
        createOptionItem3("containsBlanks" /* containsBlanks */),
        createOptionItem3("notContainsBlanks" /* notContainsBlanks */),
        createOptionItem3("containsErrors" /* containsErrors */),
        createOptionItem3("notContainsErrors" /* notContainsErrors */)
      ];
    }
    case "number" /* number */: {
      return [
        createOptionItem3("between" /* between */),
        createOptionItem3("notBetween" /* notBetween */),
        createOptionItem3("equal" /* equal */),
        createOptionItem3("notEqual" /* notEqual */),
        createOptionItem3("greaterThan" /* greaterThan */),
        createOptionItem3("greaterThanOrEqual" /* greaterThanOrEqual */),
        createOptionItem3("lessThan" /* lessThan */),
        createOptionItem3("lessThanOrEqual" /* lessThanOrEqual */)
      ];
    }
    case "timePeriod" /* timePeriod */: {
      return [
        createOptionItem3("yesterday" /* yesterday */),
        createOptionItem3("today" /* today */),
        createOptionItem3("tomorrow" /* tomorrow */),
        createOptionItem3("last7Days" /* last7Days */),
        createOptionItem3("lastWeek" /* lastWeek */),
        createOptionItem3("thisWeek" /* thisWeek */),
        createOptionItem3("nextWeek" /* nextWeek */),
        createOptionItem3("lastMonth" /* lastMonth */),
        createOptionItem3("thisMonth" /* thisMonth */),
        createOptionItem3("nextMonth" /* nextMonth */)
      ];
    }
    default:
      return [];
...
var HighlightCellStyleEditor = (props) => {
  ...
  const operatorOptions = (0, import_react7.useMemo)(() => getOperatorOptions(subType).map((option) => ({ ...option, label: localeService.t(option.label) })), [localeService, subType]);
  const [operator, setOperator] = (0, import_react7.useState)(() => {
    var _a2;
    const defaultV = (_a2 = operatorOptions[0]) == null ? void 0 : _a2.value;
    if (!rule) {
      return defaultV;
    }
  ...
  const getResult = (0, import_react7.useMemo)(() => (option) => {
    ...
    switch (option.subType || subType) {
      ...
      case "uniqueValues" /* uniqueValues */: {
        return {
          ...
          style: (_b = option.style) != null ? _b : style
        };
      }
      case "text" /* text */: {
        if (["beginsWith" /* beginsWith */, "endsWith" /* endsWith */, "containsText" /* containsText */, "notContainsText" /* notContainsText */, "equal" /* equal */, "notEqual" /* notEqual */].includes(operator)) {
          return {
            type: "highlightCell" /* highlightCell */,
            subType: (_c = option.subType) != null ? _c : subType,
            operator: (_d = option.operator) != null ? _d : operator,
            style: (_e = option.style) != null ? _e : style,
            value: (_f = option.value) != null ? _f : value
          };
        }
        break;
      }
      case "number" /* number */: {
        if (["equal" /* equal */, "notEqual" /* notEqual */, "greaterThan" /* greaterThan */, "greaterThanOrEqual" /* greaterThanOrEqual */, "lessThan" /* lessThan */, "lessThanOrEqual" /* lessThanOrEqual */].includes(operator)) {
          return {
            type: "highlightCell" /* highlightCell */,
            subType: (_g = option.subType) != null ? _g : subType,
            operator: (_h = option.operator) != null ? _h : operator,
            style: (_i = option.style) != null ? _i : style,
            value: (_j = option.value) != null ? _j : value
          };
        }
        if (["between" /* between */, "notBetween" /* notBetween */].includes(operator)) {
          return {
            type: "highlightCell" /* highlightCell */,
            subType: (_k = option.subType) != null ? _k : subType,
            operator: (_l = option.operator) != null ? _l : operator,
            style: (_m = option.style) != null ? _m : style,
            value: (_n = option.value) != null ? _n : value
          };
        }
        break;
      }
    ...
    return {
      type: "highlightCell" /* highlightCell */,
      subType: (_o = option.subType) != null ? _o : subType,
      operator: (_p = option.operator) != null ? _p : operator,
      style: (_q = option.style) != null ? _q : style
    };
  ...
  const onTypeChange = (v) => {
    ...
    const _operator = (_a2 = operatorList[0]) == null ? void 0 : _a2.value;
    setSubType(_subType);
...
var IconGroupList = (0, import_react8.forwardRef)((props, ref) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("div", { ref, dir: direction, className: "univer-w-80", children: iconGroup.map((group, index) => {
...
var IconItemList = (props) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { dir: direction, children: [
    /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
      "div",
      {
...
var IconSet = (props) => {
  ...
  const previewIcon = (0, import_react8.useMemo)(() => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
      "div",
      {
        ...
        children: list.map((icon, index) => icon ? /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
          "img",
          {
            className: "univer-size-5",
            src: icon
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { "data-u-comp": "cf-icon-set-editor", dir: direction, children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("div", { className: "univer-mt-3", children: /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
      Dropdown,
      {
        overlay: /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("div", { dir: direction, className: "univer-rounded-lg univer-p-4", children: /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
          IconGroupList,
          {
            ref: (el) => {
...
var RankStyleEditor = (props) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { children: [
    ...
    ["isNotBottom", "isBottom"].includes(type) && /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { className: "univer-mt-3 univer-flex univer-items-center univer-gap-2", children: [
      /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(
        InputNumber,
        {
          min: 1,
...
var RuleEdit = (props) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { className: "univer-mt-4 univer-flex univer-justify-end univer-gap-2", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(Button, { variant: "primary", onClick: handleSubmit, children: localeService.t("sheets-conditional-formatting-ui.panel.submit") })
    ] })
  ] });
};
...
var FILTER_BY_OPTIONS = [
  { label: "sheets-filter-ui.panel.by-values", value: 0 /* VALUES */ },
  { label: "sheets-filter-ui.panel.by-colors", value: 1 /* COLORS */ },
  { label: "sheets-filter-ui.panel.by-conditions", value: 2 /* CONDITIONS */ }
];
