...
var Params = ({ className, title, titleKey, value }) => {
  const localeService = useDependency(LocaleService);
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "univer-my-2", children: [
...
function hasActiveFormulaEmbedInteraction(scopeElement) {
  ...
  return isEventTargetInSameFormulaEmbedInteractionBoundary(scopeElement, ownerDocument == null ? void 0 : ownerDocument.activeElement);
}
var useFocus = (editor) => {
  const editorService = useDependency(IEditorService);
...
`,
  ...
  (0, import_react17.useEffect)(() => {
    ...
    const scope = (_b2 = (_a2 = resolveFormulaEmbedRuntimeDomScope(formulaEditorContainer)) != null ? _a2 : focusCoordinator.resolveRuntimeScopeByChildUnitId(editorId)) != null ? _b2 : resolveActiveFormulaEmbedRuntimeDomScope(formulaEditorContainer.ownerDocument);
    if (!scope) {
      return void 0;
    }
    const collection = new DisposableCollection();
