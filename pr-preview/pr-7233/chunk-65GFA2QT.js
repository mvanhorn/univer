...
var UnitDrawingService = class {
  ...
  initializeNotification(unitId) {
    ...
    Object.keys(data).forEach((subUnitId) => {
      ...
      if ((subUnitData == null ? void 0 : subUnitData.data) == null) {
        return;
      }
  ...
  getBatchRemoveOp(removeParams) {
    ...
    const { unitId, subUnitId } = (_b = (_a = allToRemove[0]) != null ? _a : removeParams[0]) != null ? _b : { unitId: "", subUnitId: "" };
    ...
    allToRemove.sort((a, b) => {
      ...
      const ib = (_b2 = orderIndexMap.get(b.drawingId)) != null ? _b2 : Number.NEGATIVE_INFINITY;
      return ia - ib;
    });
    const ops = [];
    const invertOps = [];
  ...
  getBatchUpdateOp(updateParams) {
    ...
    if (ops.length === 0) {
      const { unitId: unitId2, subUnitId: subUnitId2 } = updateParams[0];
      return { undo: null, redo: null, unitId: unitId2, subUnitId: subUnitId2, objects };
    }
    const op = ops.reduce(json1.type.compose, null);
    const invertOp = invertOps.reduce(json1.type.compose, null);
  ...
  _getUpdateParamCompareOp(newParam, oldParam) {
    ...
    Object.keys(newParam).forEach((key) => {
      ...
      const path = [unitId, subUnitId, "data" /* data */, drawingId, key];
      if (!hasOldKey) {
        if (newVal === void 0) {
          return;
        }
        const op2 = json1.insertOp(path, newVal);
        if (isNonEmptyOp(op2)) {
          ops.push(op2);
        }
        return;
      ...
      if (newVal === void 0) {
        const op2 = json1.removeOp(path, true);
        if (isNonEmptyOp(op2)) {
          ops.push(op2);
        }
        return;
...
// ../packages/drawing/src/utils/drawing-group.ts
var DRAWING_GROUPABLE_TYPES = [
  0 /* DRAWING_IMAGE */,
  1 /* DRAWING_SHAPE */,
  2 /* DRAWING_CHART */,
  6 /* DRAWING_GROUP */
];
function isGroupableDrawingType(type2) {
  return DRAWING_GROUPABLE_TYPES.includes(type2);
}
var DRAWING_COPY_CONTEXT_KEY = "univer.drawing.copy-plan";
...
// ../packages/drawing/src/utils/rotate-enabled.ts
function getDrawingKey(drawing) {
  return `${drawing.unitId}\0${drawing.subUnitId}\0${drawing.drawingId}`;
}
function resolveDrawingRotateEnabled(drawing, options = {}, visiting = /* @__PURE__ */ new Set()) {
  ...
  if (drawing.drawingType === 6 /* DRAWING_GROUP */) {
    visiting.add(drawingKey);
    const children = (_a = options.getChildren) == null ? void 0 : _a.call(options, drawing);
    if (children != null) {
  ...
  if (((_b = drawing.transform) == null ? void 0 : _b.rotateEnabled) === false) {
    return false;
  }
  if (((_e = (_d = (_c = options.getRenderObject) == null ? void 0 : _c.call(options, drawing)) == null ? void 0 : _d.transformerConfig) == null ? void 0 : _e.rotateEnabled) === false) {
    return false;
  }
  if ((_f = options.isKnownNonRotatableType) == null ? void 0 : _f.call(options, drawing.drawingType)) {
    return false;
  }
  return true;
}
...
// ../packages/docs-drawing/src/services/doc-drawing-adapter.service.ts
var IDocDrawingAdapterService = createIdentifier("doc.drawing-adapter.service");
var DocDrawingAdapterService = class {
  ...
  getRemoveDrawingMutationInfos(params) {
    ...
    for (const adapter of this._adapters) {
      const nextMutationInfos = (_a = adapter.getRemoveDrawingMutationInfos) == null ? void 0 : _a.call(adapter, params);
  ...
  getEditDrawingCommandInfo(params) {
    var _a;
    for (const adapter of this._adapters) {
      const commandInfo = (_a = adapter.getEditDrawingCommandInfo) == null ? void 0 : _a.call(adapter, params);
      if (commandInfo) {
        return commandInfo;
      }
    }
...
function ToolbarButton(props) {
  const localeService = useDependency(LocaleService);
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Tooltip, { title: localeService.t(props.titleKey), placement: "bottom", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    "button",
    {
      type: "button",
      ...
      children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(ToolbarGroup, { children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            ToolbarButton,
            {
              titleKey: (_d = editItem == null ? void 0 : editItem.label) != null ? _d : "drawing-ui.image-popup.edit",
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            ToolbarButton,
            {
              titleKey: (_e = cropItem == null ? void 0 : cropItem.label) != null ? _e : "drawing-ui.image-popup.crop",
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ToolbarGroup, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          ToolbarButton,
          {
            titleKey: (_f = deleteItem == null ? void 0 : deleteItem.label) != null ? _f : "drawing-ui.image-popup.delete",
...
function getDrawingRenderLayerIndex(param) {
  return param.behindText === true || param.behindText === 1 /* TRUE */ || param.layoutType === 1 /* WRAP_NONE */ && param.behindDoc === 1 /* TRUE */ ? DOC_DRAWING_BEHIND_TEXT_LAYER_INDEX : DRAWING_OBJECT_LAYER_INDEX;
}
...
var DrawingRenderService = class {
  ...
  async renderImages(imageParam, scene) {
    ...
    for (const transform of transforms) {
      ...
      const image = new Image2(imageShapeKey, imageConfig);
  ...
  _initAutoCrop() {
    this.disposeWithMe(
      this._commandService.onCommandExecuted((command) => {
        ...
        const imageShape = scene.getObject(imageShapeKey);
        if (!(imageShape instanceof Image2)) {
...
function getMenuStateByDrawingFocusChangedObservable$2(accessor, type2) {
  const drawingManagerService = accessor.get(IDrawingManagerService);
  return new Observable((subscriber) => {
    const update = (drawings) => {
      if (!drawings || drawings.length === 0) {
