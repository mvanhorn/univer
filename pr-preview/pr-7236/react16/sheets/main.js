import "../chunk-BFD4T4WX.js";
import {
  UniverVue3AdapterPlugin,
  UniverWebComponentAdapterPlugin
} from "../chunk-LMTIH6IY.js";
import "../chunk-2NZMXAM7.js";
import {
  en_US_default
...
function createNewInstance() {
  ...
  setTimeout(() => {
    import("../lazy-EF2VO74Y.js").then((lazy) => {
      const plugins = lazy.default();
      univer.registerPlugins(plugins);
    });
  }, LOAD_LAZY_PLUGINS_TIMEOUT);
  setTimeout(() => {
    import("../very-lazy-HVNW77F6.js").then((lazy) => {
      const plugins = lazy.default();
      univer.registerPlugins(plugins);
    });
