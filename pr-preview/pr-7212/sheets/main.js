...
import "../chunk-ZZVXOP3W.js";
import {
  UniverVue3AdapterPlugin,
  UniverWebComponentAdapterPlugin
} from "../chunk-B5EDUDHA.js";
import "../chunk-EFIKPYQS.js";
import {
  UniverDebuggerPlugin
} from "../chunk-3NU3PJID.js";
import "../chunk-4FBDVIOH.js";
import {
  zh_CN_default
...
} from "../chunk-4FNIV7BS.js";
import "../chunk-NXCLSAHA.js";
import {
  UniverSheetsThreadCommentPlugin
} from "../chunk-XIHRBNQQ.js";
...
function createNewInstance() {
  ...
  setTimeout(() => {
    import("../lazy-SVBIXCHC.js").then((lazy) => {
      const plugins = lazy.default();
      univer.registerPlugins(plugins);
    });
  }, LOAD_LAZY_PLUGINS_TIMEOUT);
  setTimeout(() => {
    import("../very-lazy-TN6E3KGS.js").then((lazy) => {
      const plugins = lazy.default();
      univer.registerPlugins(plugins);
    });
