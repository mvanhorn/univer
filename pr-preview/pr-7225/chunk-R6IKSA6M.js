...
var InsertDocDrawingCommand = {
  ...
  handler: (accessor, params) => {
    ...
    const contentInsertRange = explicitTextRange != null ? explicitTextRange : getContentInsertRange(accessor, unitId);
...
var RemoveDocDrawingCommand = {
  ...
  handler: (accessor, params) => {
    ...
    const unitId = (_e = removeDrawings[0]) == null ? void 0 : _e.unitId;
    if (unitId == null || removeCustomBlocks.length === 0) {
      return false;
    }
    const drawings = (_f = documentDataModel.getDrawings()) != null ? _f : {};
    ...
    for (const block of removeCustomBlocks) {
      ...
      const mutationInfos = drawingAdapterService.getRemoveDrawingMutationInfos({
        unitId,
        subUnitId: (_g = removeDrawingParam == null ? void 0 : removeDrawingParam.subUnitId) != null ? _g : unitId,
        drawing,
    ...
    batchingDisposable == null ? void 0 : batchingDisposable.dispose();
    return Boolean(result);
  }
};
...
var DocDrawingPopupMenuController = class extends RxDisposable {
  ...
  _getDrawingPopupMenuItems(unitId, subUnitId, drawingId, drawingType) {
    ...
    const editCommandInfo = drawing ? this._drawingAdapterService.getEditDrawingCommandInfo({ unitId, subUnitId, drawing }) : null;
    return [
      {
        label: (_a = editCommandInfo == null ? void 0 : editCommandInfo.label) != null ? _a : "docs-drawing-ui.image-popup.edit",
        index: 0,
        commandId: (_b = editCommandInfo == null ? void 0 : editCommandInfo.commandId) != null ? _b : EditDocDrawingOperation.id,
        commandParams: (_c = editCommandInfo == null ? void 0 : editCommandInfo.commandParams) != null ? _c : { unitId, subUnitId, drawingId },
        disable: (_d = editCommandInfo == null ? void 0 : editCommandInfo.disable) != null ? _d : drawingType === 8 /* DRAWING_DOM */
      },
      {
